...
from ..materials.mat_utils import * #update_color, hex_to_color, color_changed, color_dropdown_template, color_count_changed
...
def draw_props_mat(prefs, layout):
    
    layout.label(text='Materials',  icon='TOOL_SETTINGS')
    ...
    row.label(text="Material Preview UI:")                   
    row.prop(prefs.mat_type, 'switch_matlib_preview', text='')     
    
    box.separator() 

    row = box.row(align=True)  
    row.label(text="Material Use Nodes:") 
    row.prop(prefs.mat_type, 'mat_use_nodes', text='')                    
        
    box.separator() 

    row = box.row(align=True)  
    row.label(text="Show Node Properties:")                   
    row.prop(prefs.mat_type, 'mat_all_props', text='')     
...
# RP: MATERIAL # 
class PropsGroup_Material(bpy.types.PropertyGroup):
       
       # UI MATERIAL #
       mat_all_props : BoolProperty(name="", description="show all shader bsdf properties", default=False)   
       switch_matlib_preview : BoolProperty(name="MatLib Preview", description="switch material preview", default=False)
       ...
       id_presets : BoolProperty(name="", description="open/close", default=False)   
       fake_props : BoolProperty(name="", description="fake property", default=False)   
       
       mat_switch : EnumProperty(
              items=[("material" ,"Material Shader" ,"color values for material"),
                     ("object"   ,"Object Color"    ,"color values for object color"),                                  
                     ("utils"    ,"Material Utils"  ," tools from material utils addon")],                                  
                     name="Switch",
                     default = "material",    
                     description="switch layout between object color and material shader")       


       # GrayScale #
       mode : StringProperty(default="", description="change if operation with a string", options={'HIDDEN', 'SKIP_SAVE'}) 

       gray_scale : EnumProperty(
              items=[
                     ("gray_00" ,"0%"   ,"gray value 0%"),
                     ("gray_02" ,"20%"  ,"gray value 20%"),
                     ("gray_04" ,"40%"  ,"gray value 40%"),
                     ("gray_05" ,"50%"  ,"gray value 50%"),
                     ("gray_06" ,"60%"  ,"gray value 60%"),
                     ("gray_08" ,"80%"  ,"gray value 80%"),
                     ("gray_10" ,"100%" ,"gray value 100%"),
                     ("custom"  ,"Custom" ,"color value custom")],                                  
                     name="Gray Scale",
                     default = "custom",    
                     description="gray scale for object color",
                     options={'HIDDEN'})

       base_color : FloatVectorProperty(name="MAT-Color", default=(0.5, 1.0, 0.0, 1.0), size=4, subtype="COLOR", min=0, max=1, description="color for object/mesh", update=update_color)    
       deleteMat : IntProperty(name="Material-Slots", description="Value", default=1, min=1, soft_max=10000, step=1)


       # HEX MATERIALS #       
       def get_color(hex = "808080"):
              return FloatVectorProperty(name="Color1", default= hex_to_color(hex), size=3, subtype="COLOR", min=0.0, max=1.0, description="", update=color_changed)
       ...
       color_ID_templates : EnumProperty(
              items = [	
                     ('3d3d3d,7f7f7f,b8b8b8,ffffff',        '4x Gray'     , ''), 
                     ('003153,345d4b,688a42,9db63a,d1e231', '5x Greens'   , ''),
                     ('ff0000,0000ff,00ff00,ffff00,00ffff', '5x Code'     , ''),
                     ('3a4342,2e302f,242325,d5cc9e,d6412b', '5x Sea Wolf' , ''),
                     ('7f87a0,2d3449,000000,ffffff,f99c21', '5x Mustang'  , ''),
                     ('143240,209d8c,fed761,ffab56,fb6941', '5x Sunset'   , ''), 
                     ('0087ed,23ca7a,eceb1d,e37a29,da1c2c', '5x Heat'     , ''), 
                     ('9e00af,7026b9,4f44b5,478bf4,39b7d5,229587,47b151,9dcf46,f7f235,f7b824,f95f1e,c5513c,78574a,4d4b4b,9d9d9d', '15x Rainbow', '')], 
                     description="Color template",
                     name="Preset", 
                     update = color_dropdown_template,
                     default = 'ff0000,0000ff,00ff00,ffff00,00ffff')

       color_ID_count : IntProperty(name="Count", description="", default=5, update = color_count_changed, min = 2, max = 20)
       ...
       mat_random_object : BoolProperty(name="Random MAT", description = "random material", default = False)
