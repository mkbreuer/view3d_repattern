...
def mat_presets_group_particles(node_tree0, mat_out_0): 
        
    node_tree1 = bpy.data.node_groups.get('Particles')
    if not node_tree1:
        node_tree1 = bpy.data.node_groups.new('Particles', 'ShaderNodeTree')
        # INPUTS
        node_tree1.inputs.new('NodeSocketColor', 'Scatter Color')
        node_tree1.inputs.new('NodeSocketColor', 'Absorption Color')
        node_tree1.inputs.new('NodeSocketFloatFactor', 'Mix')
        node_tree1.inputs.new('NodeSocketFloat', 'Scatter Density')
        node_tree1.inputs.new('NodeSocketFloat', 'Absorption Density')
        node_tree1.inputs.new('NodeSocketFloat', 'Anisotropy')
        # OUTPUTS
        ...
        if hasattr(volume_scatter_1, 'location'):
            volume_scatter_1.location = (-101.55, 86.32)
        ...
        volume_scatter_1.inputs[0].default_value = (0.80, 0.80, 0.80, 1.0)
        volume_scatter_1.inputs[1].default_value = 1.0
        volume_scatter_1.inputs[2].default_value = 0.0
        ...
        if hasattr(volume_absorption_1, 'location'):
            volume_absorption_1.location = (-102.45, -86.32)
        ...
        volume_absorption_1.inputs[0].default_value = (0.80, 0.80, 0.80, 1.0)
        ...
        group_input_1.outputs[1].default_value = (0.80, 0.80, 0.80, 1.0)
        group_input_1.outputs[2].default_value = 0.5
        group_input_1.outputs[3].default_value = 1.0
        group_input_1.outputs[4].default_value = 1.0
        ...
        node_tree1.links.new(group_input_1.outputs[3], volume_scatter_1.inputs[1])
        node_tree1.links.new(group_input_1.outputs[4], volume_absorption_1.inputs[1])
        node_tree1.links.new(group_input_1.outputs[5], volume_scatter_1.inputs[2])
        ...
        node_tree1.links.new(group_input_1.outputs[2], mix_shader_1.inputs[0])

    group_0 = node_tree0.nodes.new('ShaderNodeGroup')
    if hasattr(group_0, 'node_tree'):
        group_0.node_tree = bpy.data.node_groups.get('Particles')
    ...
    if hasattr(group_0, 'width'):
        group_0.width = 140.0
    group_0.inputs[0].default_value = (0.80, 0.80, 0.80, 1.0)
    group_0.inputs[1].default_value = (0.80, 0.80, 0.80, 1.0)
    group_0.inputs[2].default_value = 0.5
    group_0.inputs[3].default_value = 1.0
    group_0.inputs[4].default_value = 1.0
