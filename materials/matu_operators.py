# bl_info = {"name": "Material Utilities", "author": "MichaleW, ChrisHinde", "version": (2, 2, 0)
...
class RTS_OT_MATUTILS_assign_material_edit(bpy.types.Operator):
    """Assign a material to the current selection"""
    bl_idname = "rts_ot.matutils_assign_material_edit"
...
class RTS_OT_MATUTILS_assign_material_object(bpy.types.Operator):
    """Assign a material to the current selection
    (See the operator panel [F9] for more options)"""

    bl_idname = "rts_ot.matutils_assign_material_object"
    bl_label = "Assign Material (Material Utilities)"
    bl_options = {'REGISTER', 'UNDO'}
...
class RTS_OT_MATUTILS_select_by_material_name(bpy.types.Operator):
    """Select geometry that has the chosen material assigned to it
    (See the operator panel [F9] for more options)"""

    bl_idname = "rts_ot.matutils_select_by_material_name"
...
class RTS_OT_MATUTILS_copy_material_to_others(bpy.types.Operator):
    """Copy the material(s) of the active object to the other selected objects"""
    bl_idname = "rts_ot.matutils_copy_material_to_others"
...
class RTS_OT_MATUTILS_clean_material_slots(bpy.types.Operator):
    """Removes any material slots from the selected objects that are not used"""
    bl_idname = "rts_ot.matutils_clean_material_slots"
...
class RTS_OT_MATUTILS_remove_material_slot(bpy.types.Operator):
    """Remove the active material slot from selected object(s)
    (See the operator panel [F9] for more options)"""
    bl_idname = "rts_ot.matutils_remove_material_slot"
...
class RTS_OT_MATUTILS_remove_all_material_slots(bpy.types.Operator):
    """Remove all material slots from selected object(s)
    (See the operator panel [F9] for more options)"""

    bl_idname = "rts_ot.matutils_remove_all_material_slots"
...
class RTS_OT_MATUTILS_replace_material(bpy.types.Operator):
    """Replace a material by name"""
    bl_idname = "rts_ot.matutils_replace_material"
...
class RTS_OT_MATUTILS_fake_user_set(bpy.types.Operator):
    """Enable/disable fake user for materials"""
    bl_idname = "rts_ot.matutils_fake_user_set"
...
class RTS_OT_MATUTILS_change_material_link(bpy.types.Operator):
    """Link the materials to Data or Object, while keeping materials assigned"""
    bl_idname = "rts_ot.matutils_change_material_link"
...
class RTS_OT_MATUTILS_merge_base_names(bpy.types.Operator):
    """Merges materials that has the same base names but ends with .xxx (.001, .002 etc)"""

    bl_idname = "rts_ot.matutils_merge_base_names"
...
class RTS_OT_MATUTILS_material_slot_move(bpy.types.Operator):
    """Move the active material slot"""
    bl_idname = "rts_ot.matutils_slot_move"
    bl_label = "Move Slot"
...
class RTS_OT_MATUTILS_join_objects(bpy.types.Operator):
    """Join objects that have the same (selected) material(s)"""
    bl_idname = "rts_ot.matutils_join_objects"
...
class RTS_OT_MATUTILS_auto_smooth_angle(bpy.types.Operator):
    """Set Auto smooth values for selected objects""" # Inspired by colkai
    bl_idname = "rts_ot.matutils_auto_smooth_angle"
